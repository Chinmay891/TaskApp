        ...
        glock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(colour=="Green"){
                    ...
                    map.put("Lock","Orange");
                    rootRef.updateChildren(map);
                    glock.setImageDrawable(getResources().getDrawable(R.drawable.lock));
                    colour="Orange";
                    ...
                    map.put("Lock","Green");
                    rootRef.updateChildren(map);
                    glock.setImageDrawable(getResources().getDrawable(R.drawable.glock));
                    colour="Green";
